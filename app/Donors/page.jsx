...
import { MapPin, Phone, Mail, Heart, Users, ChevronLeft, ChevronRight } from "lucide-react"
...
export default function OurDonors() {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-gradient-to-br from-slate-50 via-green-50 to-indigo-50">
      <Navbar />
      ...
      >
        ...
        <div className="relative max-w-4xl mx-auto text-center px-6">
          ...
          >
            ...
            <span className="text-green-700 font-medium">Our Amazing Donors</span>
          </motion.div>
          ...
          >
            Meet the wonderful people who make a difference in children's lives through their generous contributions and
            support.
          </motion.p>
        </div>
      </motion.div>
        ...
        {loading ? (
          <div className="flex flex-col items-center justify-center py-20">
            <div className="relative">
              ...
              <Heart className="w-6 h-6 text-green-600 absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2" />
            </div>
            <p className="text-gray-500 text-lg mt-4">Loading our amazing donors...</p>
          </div>
        ) : (
          <>
            <motion.div
                ...
                >
                  ...
                  <div className="relative px-6 pb-6">
                    ...
                    <div className="flex justify-center -mt-10 mb-4">
                      {donor.profilePhoto ? (
                        <div className="w-20 h-20 rounded-full overflow-hidden border-4 border-white shadow-lg">
                          <Image
                            src={donor.profilePhoto || "/placeholder.svg"}
                    ...
                    <div className="text-center mb-4">
                      <h3 className="text-xl font-bold text-gray-800 mb-1">{donor.fullName || "Anonymous Donor"}</h3>
                      {donor.email && (
                    ...
                    <div className="space-y-2 mb-6">
                      {donor.orgAddress && (
                        <div className="flex items-center space-x-2 text-gray-600">
                          ...
                          <span className="text-sm truncate">{donor.orgAddress}</span>
                        </div>
                      )}
