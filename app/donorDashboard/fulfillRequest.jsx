...
const FulfillRequests = () => {
  ...
  const handleDelete = async (donationId, requestId) => {
    ...
    try {
      ...
      setRequests(
        requests.filter((request) => request.donationId !== donationId)
              ...
              >
                  ...
                  <div className="mt-4">
                    ...
                    <ul>
                      <li className="text-sm text-gray-700">
                        Donation Type: {request.donationType} - Amount:{" "}
                        {request.donationAmount || "N/A"}
                      </li>
                      {/* Display donation details based on type */}
                      {request.donationType === "Clothes" &&
                        request.donationClothesCount && (
                          <li className="text-sm text-gray-700">
                            Number of Clothes: {request.donationClothesCount}
                          </li>
                        )}
                      {request.donationType === "Food" &&
                        request.donationFoodDescription && (
                          <li className="text-sm text-gray-700">
                ...
                <div className="flex space-x-4 mt-4">
                  ...
                  <button
                    ...
                    onClick={() =>
                      handleEdit(request.donationId, request.id, 100)
                    } // Example edit, change amount to 100
                  >
                    Edit
                  </button>
