...
export default function AccountDetails() {
  ...
  return (
    <section
      className={`${poppins.className} container mx-auto px-6 py-8 flex`}
    >
      {/* Sidebar Menu */}
      ...
      >
        ...
        <div className="mt-4">
          ...
          <p className="text-sm text-gray-500 mt-1">
            This will be how your name is displayed.
          </p>
        </div>
        ...
        <h3 className="text-lg font-bold text-gray-800 mt-6 border-b pb-2">
          Password Change
        </h3>
        ...
        {/* Save Changes Button */}
        <button className="mt-6 w-full bg-green-600 text-white py-3 px-6 font-semibold hover:bg-green-700 transition-all shadow-md">
          SAVE CHANGES
        </button>
      </motion.div>
    </section>
