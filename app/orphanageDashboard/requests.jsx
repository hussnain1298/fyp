...
export default function Request() {
          ...
          querySnapshot.docs.map(async (docRef) => {
            ...
            donationSnapshot.forEach((d) => {
              if (data.requestType === "Money") {
                ...
                totalDonated += Number(d.data().numMeals || 0)
              }
            })
  ...
  const handleSubmit = async (e) => {
    ...
    if (
      (["Clothes", "Money", "Food"].includes(form.requestType) || !!form.customType) &&
    ...
    try {
      ...
      if (["Clothes", "Money", "Food"].includes(form.requestType) || !!form.customType) {
          ...
          {requests.map((r) => (
            <div key={r.id} className="bg-gray-100 p-4 rounded-lg shadow flex justify-between items-start">
              <div>
                ...
                <p className="text-sm mt-1 text-gray-600">Type: {r.requestType}</p>
                {["Clothes", "Money", "Food", "Other"].includes(r.requestType) && (
          ...
          <div className="fixed inset-0 bg-black bg-opacity-40 flex justify-center items-center z-50">
            <div className="bg-white p-6 rounded-lg shadow-lg w-full max-w-lg">
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                {(() => {
                  const type = form.requestType === "Other" ? form.customType : form.requestType
                  return (
                    ["Clothes", "Money", "Food"].includes(type) && (
                      <div>
