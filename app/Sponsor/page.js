...
export default function SponsorAnOrphan() {
  return (
    <div className="mt-32 w-full h-[350px] mb-20 md:h-[400px] lg:h-[450px] xl:h-[500px] overflow-hidden">
      <div className="w-full h-full transition-transform duration-1000 hover:scale-105 bg-[url('/sbg6.jpg')] bg-no-repeat bg-cover bg-center">
